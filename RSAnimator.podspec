...
Pod::Spec.new do |s|
  s.name             = 'RSAnimator'
  s.version          = '0.1.0'
  s.summary          = 'A short description of RSAnimator.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/lyonLiu/RSAnimator'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'lyonLiu' => 'lyonLiu_job@163.com' }
  s.source           = { :git => 'https://github.com/lyonLiu/RSAnimator.git', :tag => s.version.to_s }
